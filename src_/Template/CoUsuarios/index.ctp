	...
	<div class="col-lg-12"> 
	   <div class="text-center">
        ...
        <div class="text-right">
            <?php echo $this->Html->link('<i class="icon md-plus" aria-hidden="true"></i>Nuevo Usuario', ['action' => 'add'],['escape'=>false,'class'=>'btn btn-primary waves-effect waves-classic']) ?>
        </div>
        <br>
	</div>
	<div class="col-lg-12">
            <table id="coUsuarios" class="table table-hover dataTable table-striped w-full">
                <thead>
                    <tr>
                        <th>Id</th>
                        <th>Nombre</th>
...
<script type="text/javascript" charset="utf-8">
	...
	var tbl = $('#coUsuarios');
    var tabla = $('#coUsuarios').DataTable({
            "bProcessing": true,
            "bServerSide": true,
            'responsive': true,  
            "sAjaxSource": "<?php echo $this->Url->build(array('controller'=>'co_usuarios','action'=>'get_data','_ext'=>'json')); ?>",
            'dom': 'Bfrtip',
