...
<div class="row">
	<div class="col-lg-12">
	   <div class="text-center">
	     <h2>Administraci&oacute;n de Actividades</h2>
	   </div>
	...
	<div class="col-lg-12">
	 	<table id="catActividade" class="table table-hover dataTable table-striped w-full">
	        <thead>
	             <tr>
<!--		                <th>id</th>-->
		                <th>Nombre</th>
...
<script type="text/javascript" charset="utf-8">
	...
	var tbl = $('#catActividade');

    var tabla = $('#catActividade').DataTable({
            "bProcessing": true,
            "bServerSide": true,
            'responsive': true,
