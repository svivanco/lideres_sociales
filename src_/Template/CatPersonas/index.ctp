	...
	<div class="modal-dialog modal-simple  modal-lg">
		<div class="modal-content">
			...
			<?= $this->Form->create($catPersona,['url'=>['action'=>'add'],'role'=>'form','onsubmit'=>'return checkSubmit();','type'=>'file']) ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <?= $this->Form->control('cat_persona_pertence_id',['options'=>$catPersonasPertenece,'empty'=>true,'label'=>'A Cargo de ']) ?>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <?= $this->Form->control('ine') ?>
                    </div>
                </div>
                <div class="row">
				    <div class="col-md-4">
                ...
                <div class="row">
                    ...
                    ?>
                    <?php
                         echo $this->Form->control('cat_localidade_id', ['type'=>'hidden','label'=>['text'=>'Localidades']]);
                    ?>
