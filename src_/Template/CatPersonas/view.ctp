...
<div class="row">
	<div class="col-lg-3">
		<div class="list-group">
			...
			<?= $this->Html->link('<i class="icon md-format-list-bulleted">&nbsp;</i>&nbsp;Listado', ['action' => 'index',$catPersona->cat_municipio_id,$catPersona->cat_cargo_id],['class'=>'list-group-item','escape'=>false]) ?>
	    </div>	
	</div>
	<div class="col-sm-9">
		<div class="panel panel-primary panel-line">
            ...
            <div class="panel-body">
			    ...
			    <table class="table table-striped table-bordered">
                    <tr>
                        <th scope="row" colspan="2"><?= __('Ine') ?></th>
                        <td colspan="2"><?= h($catPersona->ine) ?></td>
                    </tr>
					<tr>
                    ...
                    <tr>
                        ...
                        <th scope="row"><?= __('Cruzamientos') ?></th>
                        <td><?= h($catPersona->cruzamientos) ?></td>
                    </tr>
                    <tr>
                ...
                <div class="related">
                    ...
                    <div class="related">
                        ...
                        <table class="table table-bordered" cellpadding="0" cellspacing="0">
                            ...
                            <?php foreach ($catPersona->cat_temas as $tema): ?>
                            <tr>
                                <td><?= h($tema->name) ?></td>
                            </tr>
                            <?php endforeach; ?>
                ...
                <div class="related">
                    ...
                    <?php if (!empty($catPersona->cat_actividades)): ?>
                        <table class="table table-bordered" cellpadding="0" cellspacing="0">
                            ...
                            <?php foreach ($catPersona->cat_actividades as $actividade): ?>
                                <tr>
