	...
	<div class="col-lg-9">
    	<div class="panel panel-primary panel-line">
	        <div class="panel-heading">
	            <h2 class="panel-title"> <?= __('Edit Cat Colonia') ?></h2>
	        </div>
	        <div class="panel-body">
        		<?= $this->Form->create($catColonia,['role'=>'form','onsubmit'=>'return checkSubmit();']) ?>
        	        			
				<?php
            		echo $this->Form->control('codigo_postal', ['label'=>[]]);
            		echo $this->Form->control('cat_estado_id', ['label'=>[]]);
            		echo $this->Form->control('cat_municipio_id', ['label'=>[]]);
            		echo $this->Form->control('ciudad', ['label'=>[]]);
            		echo $this->Form->control('tipo_asentamiento', ['label'=>[]]);
            		echo $this->Form->control('asentamiento', ['label'=>[]]);
            		echo $this->Form->control('clave_oficina', ['label'=>[]]);
	        ?>
