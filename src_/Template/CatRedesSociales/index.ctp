...
<div class="row">
	<div class="col-lg-12"> 
	   <div class="text-center">
	     <h2>Administraci&oacute;n de Cat Redes Sociales</h2>        
	   </div> 
	    <div class="text-right">
	        <?php echo $this->Html->link('<i class="icon md-plus" aria-hidden="true"></i>&nbsp; Nuevo catRedesSociale' , ['action' => 'add'],['escape'=>false,'class'=>'btn btn-primary waves-effect waves-classic']) ?>
	    </div>
	    <br>
	</div>
	
	<div class="col-lg-12">
	 	<table id="catRedesSociale" class="table table-hover dataTable table-striped w-full">
	        <thead>
	             <tr>
		                <th>id</th>
		                <th>name</th>
...
<script type="text/javascript" charset="utf-8">
	...
	var tbl = $('#catRedesSociale');

    var tabla = $('#catRedesSociale').DataTable({
            "bProcessing": true,
            "bServerSide": true,
            'responsive': true,
        	...
        	"buttons":
        			   	[
							...
							{
								extend: 'excelHtml5',
								title: 'Lista de "catRedesSociale"',
