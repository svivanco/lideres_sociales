	...
	<div class="col-lg-9">
    	<div class="panel panel-primary panel-line">
	        <div class="panel-heading">
	            <h2 class="panel-title"> <?= __('Agregar Estatus') ?></h2>
	        </div>
	        <div class="panel-body">
        		<?= $this->Form->create($catEstatus,['role'=>'form','onsubmit'=>'return checkSubmit();']) ?>

				<?php
            		echo $this->Form->control('name', ['label'=>['text'=>'Nombre']]);
            		echo $this->Form->control('editar', ['label'=>['text'=>' Editar']]);
            		echo $this->Form->control('clase', ['label'=>[]]);
	        ?>
