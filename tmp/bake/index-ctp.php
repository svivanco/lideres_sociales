	...
	<div class="col-lg-12"> 
	   <div class="text-center">
	    ...
	    <div class="text-right">
	        <CakePHPBakeOpenTagphp echo $this->Html->link('<i class="icon md-plus" aria-hidden="true"></i>&nbsp; Nuevo <?= $singularVar ?>' , ['action' => 'add'],['escape'=>false,'class'=>'btn btn-primary waves-effect waves-classic']) CakePHPBakeCloseTag>
	    </div>
	    <br>
	</div>
...
<script type="text/javascript" charset="utf-8">
    ...
    var tabla = $('#<?= $singularVar ?>').DataTable({
            ...
            "bServerSide": true,
            'responsive': true,
            "sAjaxSource": "<CakePHPBakeOpenTagphp echo $this->Url->build(array('action'=>'get_data','_ext'=>'json')); CakePHPBakeCloseTag>", 
			'dom': 'Bfrtip',	
        	"buttons":
        			   	[
        			   		{
...
//																doc.pageMargins = [10,10,10,10];
															...
															doc['footer']=(function(page, pages) 
															{
																return {
																    columns: [
																        'Elaborado por: <CakePHPBakeOpenTagphp echo $this->request->Session()->read('Auth.User.nombre_completo')CakePHPBakeCloseTag>',
																        {
