...
use App\Model\Table\OpeEncuestasServiciosTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\OpeEncuestasServiciosTable Test Case
 */
class OpeEncuestasServiciosTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\OpeEncuestasServiciosTable
     */
    public $OpeEncuestasServicios;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('OpeEncuestasServicios') ? [] : ['className' => 'App\Model\Table\OpeEncuestasServiciosTable'];
        $this->OpeEncuestasServicios = TableRegistry::get('OpeEncuestasServicios', $config);
    }
    ...
    {
        unset($this->OpeEncuestasServicios);
