...
use App\Model\Table\OpeDetalleInventariosTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\OpeDetalleInventariosTable Test Case
 */
class OpeDetalleInventariosTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\OpeDetalleInventariosTable
     */
    public $OpeDetalleInventarios;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('OpeDetalleInventarios') ? [] : ['className' => 'App\Model\Table\OpeDetalleInventariosTable'];
        $this->OpeDetalleInventarios = TableRegistry::get('OpeDetalleInventarios', $config);
    }
    ...
    {
        unset($this->OpeDetalleInventarios);
