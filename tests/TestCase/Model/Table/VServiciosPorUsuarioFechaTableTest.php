...
use App\Model\Table\VServiciosPorUsuarioFechaTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\VServiciosPorUsuarioFechaTable Test Case
 */
class VServiciosPorUsuarioFechaTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\VServiciosPorUsuarioFechaTable
     */
    public $VServiciosPorUsuarioFecha;
     ...
     */
    public $fixtures = [
        'app.v_servicios_por_usuario_fecha',
        'app.co_usuarios',
        'app.cat_empleados',
        'app.cat_unidades',
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('VServiciosPorUsuarioFecha') ? [] : ['className' => 'App\Model\Table\VServiciosPorUsuarioFechaTable'];
        $this->VServiciosPorUsuarioFecha = TableRegistry::get('VServiciosPorUsuarioFecha', $config);
    }
    ...
    {
        unset($this->VServiciosPorUsuarioFecha);
