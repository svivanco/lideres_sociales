...
use App\Model\Table\OpeAnexosTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\OpeAnexosTable Test Case
 */
class OpeAnexosTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\OpeAnexosTable
     */
    public $OpeAnexos;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('OpeAnexos') ? [] : ['className' => 'App\Model\Table\OpeAnexosTable'];
        $this->OpeAnexos = TableRegistry::get('OpeAnexos', $config);
    }
