...
use App\Model\Table\HistorialOpeInventariosTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\HistorialOpeInventariosTable Test Case
 */
class HistorialOpeInventariosTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\HistorialOpeInventariosTable
     */
    public $HistorialOpeInventarios;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('HistorialOpeInventarios') ? [] : ['className' => 'App\Model\Table\HistorialOpeInventariosTable'];
        $this->HistorialOpeInventarios = TableRegistry::get('HistorialOpeInventarios', $config);
    }
    ...
    {
        unset($this->HistorialOpeInventarios);
