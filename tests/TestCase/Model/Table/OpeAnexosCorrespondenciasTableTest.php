...
use App\Model\Table\OpeAnexosCorrespondenciasTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\OpeAnexosCorrespondenciasTable Test Case
 */
class OpeAnexosCorrespondenciasTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\OpeAnexosCorrespondenciasTable
     */
    public $OpeAnexosCorrespondencias;
    ...
    public $fixtures = [
        ...
        'app.ope_anexo_correspondencias'
    ];
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('OpeAnexosCorrespondencias') ? [] : ['className' => 'App\Model\Table\OpeAnexosCorrespondenciasTable'];
        $this->OpeAnexosCorrespondencias = TableRegistry::get('OpeAnexosCorrespondencias', $config);
    }
    ...
    {
        unset($this->OpeAnexosCorrespondencias);
