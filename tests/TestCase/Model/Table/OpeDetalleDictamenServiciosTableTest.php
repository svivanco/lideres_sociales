...
use App\Model\Table\OpeDetalleDictamenServiciosTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\OpeDetalleDictamenServiciosTable Test Case
 */
class OpeDetalleDictamenServiciosTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\OpeDetalleDictamenServiciosTable
     */
    public $OpeDetalleDictamenServicios;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('OpeDetalleDictamenServicios') ? [] : ['className' => 'App\Model\Table\OpeDetalleDictamenServiciosTable'];
        $this->OpeDetalleDictamenServicios = TableRegistry::get('OpeDetalleDictamenServicios', $config);
    }
    ...
    {
        unset($this->OpeDetalleDictamenServicios);
