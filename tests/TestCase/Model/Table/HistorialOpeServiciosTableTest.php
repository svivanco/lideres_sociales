...
use App\Model\Table\HistorialOpeServiciosTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\HistorialOpeServiciosTable Test Case
 */
class HistorialOpeServiciosTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\HistorialOpeServiciosTable
     */
    public $HistorialOpeServicios;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('HistorialOpeServicios') ? [] : ['className' => 'App\Model\Table\HistorialOpeServiciosTable'];
        $this->HistorialOpeServicios = TableRegistry::get('HistorialOpeServicios', $config);
    }
    ...
    {
        unset($this->HistorialOpeServicios);
