...
class CatEstadosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'abreviatura' => ['type' => 'string', 'length' => 15, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'abreviatura' => 'Lorem ipsum d',
            'activo' => 1,
            'created' => '2018-02-05 19:16:13',
            'modified' => '2018-02-05 19:16:13'
        ],
    ];
}
