...
<div class="row">
	<div class="col-lg-12"> 
	   <div class="text-center">
	     <h2>Administraci&oacute;n de Cat Organizaciones</h2>        
	   </div> 
	    <div class="text-right">
	        <?php echo $this->Html->link('<i class="icon md-plus" aria-hidden="true"></i>&nbsp; Nuevo catOrganizacione' , ['action' => 'add'],['escape'=>false,'class'=>'btn btn-primary waves-effect waves-classic']) ?>
	    </div>
	    <br>
	</div>
	
	<div class="col-lg-12">
	 	<table id="catOrganizacione" class="table table-hover dataTable table-striped w-full">
	        <thead>
	             <tr>
		                <th>id</th>
		                <th>name</th>
...
<script type="text/javascript" charset="utf-8">
	...
	var tbl = $('#catOrganizacione');

    var tabla = $('#catOrganizacione').DataTable({
            "bProcessing": true,
            "bServerSide": true,
            'responsive': true,
        	...
        	"buttons":
        			   	[
							...
							{
								extend: 'excelHtml5',
								title: 'Lista de "catOrganizacione"',
