...
?>
    ...
    <div class="table-reponsive">
	    <table id="coPermisos" class="table table-bordered table-condensed dt-responsive nowrap" cellspacing="0" width="100%">
	        <thead>                          
	        <tr class="info">
	            <th>Id</th>
	            <th>Nombre</th>
...
<script type="text/javascript" charset="utf-8">
	...
	var tbl = $('#coPermisos');
    var tabla = $('#coPermisos').DataTable({
        "bProcessing": true,
        "bServerSide": true,
        'responsive': true,
        "sAjaxSource": "<?php echo $this->Url->build(array('controller'=>'co_permisos','action'=>'get_data','_ext'=>'json')); ?>",
											...
											customize: function (doc)
																	{
																        ...
																        doc['footer']=(function(page, pages) 
																        {
																            return {
																                columns: [
																            		{ alignment: 'left',text: ["Elaborado por: <?php echo $this->request->Session()->read('Auth.User.nombre_completo')?>"]},
																                    {
