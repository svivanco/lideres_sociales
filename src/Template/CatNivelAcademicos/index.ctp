...
<div class="row">
	<div class="col-lg-12">
	   <div class="text-center">
	     <h2>Administraci&oacute;n de Niveles Academicos</h2>
	   </div>
	...
	<div class="col-lg-12">
	 	<table id="catNivelAcademico" class="table table-hover dataTable table-striped w-full">
	        <thead>
	             <tr>
		                <th>Nombre</th>
		                <th>Creado</th>
...
<script type="text/javascript" charset="utf-8">
	...
	var tbl = $('#catNivelAcademico');

    var tabla = $('#catNivelAcademico').DataTable({
            "bProcessing": true,
            "bServerSide": true,
            'responsive': true,
        	...
        	"buttons":
        			   	[
							...
							{
								extend: 'excelHtml5',
								title: 'Lista de "catNivelAcademico"',
