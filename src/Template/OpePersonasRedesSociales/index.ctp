...
<div class="row">
	<div class="col-lg-12"> 
	   <div class="text-center">
	     <h2>Administraci&oacute;n de Ope Personas Redes Sociales</h2>        
	   </div> 
	    <div class="text-right">
	        <?php echo $this->Html->link('<i class="icon md-plus" aria-hidden="true"></i>&nbsp; Nuevo opePersonasRedesSociale' , ['action' => 'add'],['escape'=>false,'class'=>'btn btn-primary waves-effect waves-classic']) ?>
	    </div>
	    <br>
	</div>
	
	<div class="col-lg-12">
	 	<table id="opePersonasRedesSociale" class="table table-hover dataTable table-striped w-full">
	        <thead>
	             <tr>
		                <th>id</th>
		                <th>cat_persona_id</th>
		                <th>cat_redes_sociale_id</th>
		                <th>enlace</th>
		                <th>activo</th>
		                <th>created</th>
		                <th>modified</th>
...
<script type="text/javascript" charset="utf-8">
	...
	var tbl = $('#opePersonasRedesSociale');

    var tabla = $('#opePersonasRedesSociale').DataTable({
            "bProcessing": true,
            "bServerSide": true,
            'responsive': true,
        	...
        	"buttons":
        			   	[
							...
							{
								extend: 'excelHtml5',
								title: 'Lista de "opePersonasRedesSociale"',
