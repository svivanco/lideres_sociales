	...
	<div class="col-lg-9">
    	<div class="panel panel-primary panel-line">
	        <div class="panel-heading">
	            <h2 class="panel-title"> <?= __('Edit Ope Personas Redes Sociale') ?></h2>
	        </div>
	        <div class="panel-body">
        		<?= $this->Form->create($opePersonasRedesSociale,['role'=>'form','onsubmit'=>'return checkSubmit();']) ?>
        	        			
				<?php
            		echo $this->Form->control('cat_persona_id', ['options' => $catPersonas,'label'=>['']]);
            		echo $this->Form->control('cat_redes_sociale_id', ['options' => $catRedesSociales,'label'=>['']]);
            		echo $this->Form->control('enlace', ['label'=>[]]);
