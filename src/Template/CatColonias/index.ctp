...
<div class="row">
	<div class="col-lg-12"> 
	   <div class="text-center">
	     <h2>Administraci&oacute;n de Cat Colonias</h2>        
	   </div> 
	    <div class="text-right">
	        <?php echo $this->Html->link('<i class="icon md-plus" aria-hidden="true"></i>&nbsp; Nuevo catColonia' , ['action' => 'add'],['escape'=>false,'class'=>'btn btn-primary waves-effect waves-classic']) ?>
	    </div>
	    <br>
	</div>
	
	<div class="col-lg-12">
	 	<table id="catColonia" class="table table-hover dataTable table-striped w-full">
	        <thead>
	             <tr>
		                <th>id</th>
		                <th>codigo_postal</th>
...
<script type="text/javascript" charset="utf-8">
    ...
    var tabla = $('#catColonia').DataTable({
            "bProcessing": true,
            "bServerSide": true,
            'responsive': true,
