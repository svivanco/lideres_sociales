...
<div class="row">
	<div class="col-lg-12"> 
	   <div class="text-center">
	     <h2>Administraci&oacute;n de Cat Distritos Federales</h2>        
	   </div> 
	    <div class="text-right">
	        <?php echo $this->Html->link('<i class="icon md-plus" aria-hidden="true"></i>&nbsp; Nuevo catDistritosFederale' , ['action' => 'add'],['escape'=>false,'class'=>'btn btn-primary waves-effect waves-classic']) ?>
	    </div>
	    <br>
	</div>
	
	<div class="col-lg-12">
	 	<table id="catDistritosFederale" class="table table-hover dataTable table-striped w-full">
	        <thead>
	             <tr>
		                <th>id</th>
		                <th>name</th>
...
<script type="text/javascript" charset="utf-8">
	...
	var tbl = $('#catDistritosFederale');

    var tabla = $('#catDistritosFederale').DataTable({
            "bProcessing": true,
            "bServerSide": true,
            'responsive': true,
        	...
        	"buttons":
        			   	[
							...
							{
								extend: 'excelHtml5',
								title: 'Lista de "catDistritosFederale"',
