	...
	<div class="col-lg-9">
    	<div class="panel panel-primary panel-line">
	        <div class="panel-heading">
	            <h2 class="panel-title"> <?= __('Edit Cat Distritos Federale') ?></h2>
	        </div>
	        <div class="panel-body">
        		<?= $this->Form->create($catDistritosFederale,['role'=>'form','onsubmit'=>'return checkSubmit();']) ?>
        	        			
				<?php
            		echo $this->Form->control('name', ['label'=>[]]);
            	echo $this->Form->control('cat_municipios._ids', ['options' => $catMunicipios,'label'=>[]]);
	        ?>
