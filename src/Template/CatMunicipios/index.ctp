...
<div class="row">
	<div class="col-lg-12">
	   <div class="text-center">
	     <h2>Cat&aacute;logo de Municipios</h2>
	   </div>
	    <div class="text-right">
	        <?php echo $this->Html->link('<i class="icon md-plus" aria-hidden="true"></i>&nbsp; Nuevo Municipio' , ['action' => 'add'],['escape'=>false,'class'=>'btn btn-primary waves-effect waves-classic']) ?>
	    </div>
	    <br>
	</div>

	<div class="col-lg-12">
	 	<table id="catMunicipio" class="table table-hover dataTable table-striped w-full">
	        <thead>
	             <tr>
		                <th>Municipio</th>
...
<script type="text/javascript" charset="utf-8">
	...
	var tbl = $('#catMunicipio');

    var tabla = $('#catMunicipio').DataTable({
            "bProcessing": true,
            "bServerSide": true,
            'responsive': true,
