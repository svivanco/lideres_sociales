	...
	<div class="col-lg-9">
    	<div class="panel panel-primary panel-line">
	        <div class="panel-heading">
	            <h2 class="panel-title"> <?= __('Agregar Municipio') ?></h2>
	        </div>
	        <div class="panel-body">
        		<?= $this->Form->create($catMunicipio,['role'=>'form','onsubmit'=>'return checkSubmit();']) ?>

				<?php
                    echo $this->Form->control('cat_estado_id', ['options'=>$catEstados,'empty'=>true,'label'=>['text'=>'Estado']]);
            		echo $this->Form->control('name', ['label'=>['text'=>'Municipio']]);
	        ?>
...
<script type="text/javascript">
   	$("#cat-estado-id").select2	({placeholder: "SELECCIONAR",allowClear: true});
</script>
