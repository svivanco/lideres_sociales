...
<div class="row">
	<div class="col-lg-12">
	   <div class="text-center">
	     <h2>Administraci&oacute;n de Temas</h2>
	   </div>
	...
	<div class="col-lg-12">
	 	<table id="catTema" class="table table-hover dataTable table-striped w-full">
	        <thead>
	             <tr>
		                <th>Nombre</th>
		                <th>Activo</th>
