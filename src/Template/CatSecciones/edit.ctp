	...
	<div class="col-lg-9">
    	<div class="panel panel-primary panel-line">
	        <div class="panel-heading">
	            <h2 class="panel-title"> <?= __('Edit Cat Seccione') ?></h2>
	        </div>
	        <div class="panel-body">
        		<?= $this->Form->create($catSeccione,['role'=>'form','onsubmit'=>'return checkSubmit();']) ?>
        	        			
				<?php
            		echo $this->Form->control('cat_municipio_id', ['options' => $catMunicipios, 'empty' => true,'label'=>['']]);
            		echo $this->Form->control('cat_distrito_id', ['options' => $catDistritos, 'empty' => true,'label'=>['']]);
