...
<div class="row">
	<div class="col-lg-12"> 
	   <div class="text-center">
	     <h2>Administraci&oacute;n de Cat Secciones</h2>        
	   </div> 
	    <div class="text-right">
	        <?php echo $this->Html->link('<i class="icon md-plus" aria-hidden="true"></i>&nbsp; Nuevo catSeccione' , ['action' => 'add'],['escape'=>false,'class'=>'btn btn-primary waves-effect waves-classic']) ?>
	    </div>
	    <br>
	</div>
	
	<div class="col-lg-12">
	 	<table id="catSeccione" class="table table-hover dataTable table-striped w-full">
	        <thead>
	             <tr>
		                <th>id</th>
		                <th>cat_municipio_id</th>
		                <th>cat_distrito_id</th>
		                <th>name</th>
		                <th>activo</th>
		                <th>created</th>
		                <th>modified</th>
...
<script type="text/javascript" charset="utf-8">
    ...
    var tabla = $('#catSeccione').DataTable({
            "bProcessing": true,
            "bServerSide": true,
            'responsive': true,
