 ...
 * @property \Cake\ORM\Association\BelongsTo $CatDistritosFederales
...
class CatSeccionesTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->belongsTo('CatDistritosFederales', [
    ...
    public function buildRules(RulesChecker $rules)
    {
        ...
        $rules->add($rules->existsIn(['cat_distritos_federale_id'], 'CatDistritosFederales'));
